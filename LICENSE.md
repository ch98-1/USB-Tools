...
Some KiCad Library Files are licensed under [KiCad Libraries License] (http://kicad-pcb.org/libraries/license/)
...
This hardware is provided 'as-is', without any express or implied
warranty. In no event will the authors be held liable for any damages
arising from the use of this hardware.

Permission is granted to anyone to use this hardware for any purpose,
including commercial applications, and to alter it and redistribute it
freely, subject to the following restrictions:

1. The origin of this hardware must not be misrepresented; you must not
   claim that you wrote the original hardware. If you use this hardware
   in a product, an acknowledgment in the product documentation would be
   appreciated but is not required.
2. Altered source versions must be plainly marked as such, and must not be
   misrepresented as being the original hardware.
